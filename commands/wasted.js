...
module.exports = {
    name: 'wasted', //name of the module
    description: 'Wasted', // short description of what this command does
    command: '!wasted', //command with prefix. Ex command: '!test'
    commandType: 'reactions', // admin|info|plugin
    isDependent: false, //whether this command is related/dependent to some other command
    help: "*Wasted*\n_Reply *!wasted* To Someone's Message_", // a string descring how to use this command Ex = help : 'To use this command type !test arguments'
    execute};