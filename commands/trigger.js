...
if(!cmd_user.isMe){
try{
const data =await Levels.fetch("Global", "Global", false);
...
module.exports = {
    name: 'trigger', //name of the module
    description: 'TRIGGERED !', // short description of what this command does
    command: '!trigger', //command with prefix. Ex command: '!test'
    commandType: 'reactions', // admin|info|plugin
    isDependent: false, //whether this command is related/dependent to some other command
    help: "*Trigger*\n_Reply *!trigger* To Someone's Message_", // a string descring how to use this command Ex = help : 'To use this command type !test arguments'
    execute};