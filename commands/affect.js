...
module.exports = {
    name: 'affect', //name of the module
    description: 'No, It Doesnt Affect My Baby Meme', // short description of what this command does
    command: '!affect', //command with prefix. Ex command: '!test'
    commandType: 'reactions', // admin|info|plugin
    isDependent: false, //whether this command is related/dependent to some other command
    help: "*Affect*\n_Reply *!affect* To Someone's Message_", // a string descring how to use this command Ex = help : 'To use this command type !test arguments'
    execute};