...
module.exports = {
    name: 'Wanted', //name of the module
    description: 'Make Someone Wanted', // short description of what this command does
    command: '!wanted', //command with prefix. Ex command: '!test'
    commandType: 'reactions', // admin|info|plugin
    isDependent: false, //whether this command is related/dependent to some other command
    help: "*Wanted*\n_Reply *!wanted* To Someone's Message_", // a string descring how to use this command Ex = help : 'To use this command type !test arguments'
    execute};