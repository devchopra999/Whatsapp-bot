...
module.exports = {
    name: 'shit', //name of the module
    description: 'Ew,I Stepped In Shit Meme', // short description of what this command does
    command: '!shit', //command with prefix. Ex command: '!test'
